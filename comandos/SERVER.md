...
```
git remote add agendarepo slrvcvieira@34.125.53.113:~/agendarepo
...
postgres=# create role athenas with login superuser createdb createrole password 'athenas@1975';
CREATE ROLE
postgres=# create database agenda with owner athenas;
CREATE DATABASE
postgres=# grant all privileges on database agenda to athenas;
GRANT
postgres=# \q
